...
class FrontPage extends Component {
  render() {
    ...
    <Text style={styles.title}>College</Text>
        ...
        <Text>  </Text>
          <Button onPress={() => {that.props.parent.setState({destination:"FrontPage"})}} title= "Top universities for baseball" />
        </View>

        <Text style={styles.title}>Pro</Text>
              <View
                style = {{flexDirection:"row" ,justifyContent:"space-around",paddingTop:"30px"}}>
                <Button onPress={() => {that.props.parent.setState({destination:"FrontPage"})}} title= "MLB" />
                <Text>  </Text>
                <Button onPress={() => {that.props.parent.setState({destination:"FrontPage"})}} title= "AAA Minors" />
                </View>
